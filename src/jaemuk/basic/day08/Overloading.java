...
public class Overloading {
    public static void main(String[] args) {
        ...
        // 같은 이름의 메서드를 2개 이상 선언하는 것

        // 정수/실수 매개변수를 2개 또는 3개를
        // 이용해서 간단한 덧셈을 수행하는 프로그램 작성
        NonOver no = new NonOver();
        System.out.println(no.add_int(3, 5));
        System.out.println(no.add_int3(3,2,7));
        System.out.println(no.add_double(10.7,30));

        Over ov = new Over();
        System.out.println(ov.add(1,3));
        System.out.println(ov.add(1,3,4));
        System.out.println(ov.add(1.3, 3.0));
