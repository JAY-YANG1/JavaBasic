...
public class EmployeeServiceImpl implements EmployeeService{
    ...
    // 단일 상수 선언
    static final String[] JOBID = {"AD_VP", "AD_PRESS", "IT_PROG", "FI_MGR", "FI_ACCOUNT"};
    ...
    public static EmployeeService getInstance() {
        if (empsrv == null) {
            empsrv = new EmployeeServiceImpl();
        } return empsrv;
    }
    // 싱글톤 끝
    ...
    public void makeExtInfo(EmployeeVO emp) {
        ...
        int deptid = (rnd.nextInt(MAXDEPT) % 10) * 10;
