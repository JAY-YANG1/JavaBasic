...
public class Exceptions {
    public static void main(String[] args) throws IOException {
        ...
        // 강제종료 시키지만, 발생할 수 있는 상황을
        // 미리 예측해서 코드로 예방할 수 있음
        ...
        try {
            while (true) {
                System.out.println("숫자 하나를 입력해주세요(1 ~ 9사이)");
                k = sc.nextInt();
                if (k >= 1 && k <= 9) {
                    break;
                } else {
        ...
        // 명시적인 예외처리를 반드시 강제함 (!!)
        // 예외발생 시점은 컴파일 할때 compile time 임
        // IOException
        // ClassNotFoundException

        // ex) 임의의 성적데이터(이름, 국어, 영어, 수학)를
        // c:/Java/sungjuk.txt 에 저장하는 프로그램 작성
        String fpath = "/users/yjm/sungjuk.txt";
        ...
        // 메서드를 호출한 상위메서드에서
        // 이것을 처리할 수 있도록 함
        // 이틀 통해서 각 하위 메서드들에서 발생하는 예외들을
        // 한 곳에 모아서 처리할 수 있음
        // 또한, 메서드에 try - catch 문을
        // 사용하지 않아도 된다는 장점이 있음

        fpath = "/users/yjm/sungjuk.txt";
