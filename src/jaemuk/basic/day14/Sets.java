...
public class Sets {
    public static void main(String[] args) {
        ...
        // banana, peach, apple 등을 set 으로 저장
        ...
        // 저장되어 있는 객체들 해시코드를 비교해서
        // 같은 해시코드가 존재한다면 동일 객체로 판단 - 저장하지 않음
        // 객체의 해시코드를 알려면 hashcode 메서드 사용
        for(String fruit : fruits) {
        ...
        // HashSet 의 개별요소 출력
        // set 에는 get 메서드가 지원되지 않음
        // 단, contains 를 이용해서 검색을 통한 개별값 출력은 가능
