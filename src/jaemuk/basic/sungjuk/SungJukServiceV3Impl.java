...
public class SungJukServiceV3Impl implements SungJukServiceV3 {
    ...
    // 성적데이터를 저장해둘 파일경로 지정
    String fpath = "/users/yjm/desktop/Java/SungJuk.data";
    String fpath2 = "/users/yjm/desktop/Java/SungJuk.csv";
    String fpath3 = "/users/yjm/desktop/Java/SungJuk.json";
    ...
    public static SungJukServiceV3 getInstance() {
        if (sjsrv == null) {
            sjsrv = new SungJukServiceV3Impl();
        }
        return sjsrv;
    }
    // 싱글톤 패턴 끝
    ...
    public void showOneSungJuk() {
        ...
        try {
            ...
            System.out.printf(fmt, pos, sj.getName(), sj.getKor(), sj.getEng(),
    ...
    public void initSungJuk() {
        ...
        try {
            ...
            ex.printStackTrace();
            System.out.println("파일이 없거나 시스템오류입니다!");
        } finally {
            if (ois != null) {
