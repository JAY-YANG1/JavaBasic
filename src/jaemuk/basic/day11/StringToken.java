...
public class StringToken {
    public static void main(String[] args) {
        ...
        // 이렇게 쪼개진 각 문자들은 token 이라 부름
        // 단순한 문자열을 나눌때는 StringTokenizer 가 유리
        // 복잡한 문자열을 정규식을 이용해서 나눌 때는 split 이 유리
        ...
        // 지정하지 않더라도 기본구분자에 의해 문자열을 적절히 쪼갬
        StringTokenizer st = new StringTokenizer(str, " ");
        ...
        // StringTokenizer 는 iterable 자료구조임
