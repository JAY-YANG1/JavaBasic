...
public class JavaCalendar {
    public static void main(String[] args) {
        // 자바에서 시간, 날짜 다루기
        // JDK1 에서 제공한 Date 클래스를 이용해서
        // 날짜, 시간에 대한 처리를 할 수 있지만
        // JDK1.1 에 나온 Calendar 클래스를 이용해서
        ...
        System.out.println("오늘은 2021년 중 " +c.get(Calendar.DAY_OF_YEAR)+ "일째 날입니다");
        ...
        // JDK8 에서 추가된 JodaTime 사용하기
        // java.time 패키지
        // 날짜를 표현할 때는 LocalDate
        // 날짜를 표현할 때는 LocalTime
