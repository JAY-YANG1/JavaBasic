...
public class JavaLang {
    public static void main(String[] args) {
        ...
        // Object 클래스
        // 모든 클래스의 조상
        // toString, equals, hashCode 외
        // 6개의 메서드가 추가 정의되어 있음
        // 대다수 클래스는 Object 클래스가 제공하는
        // toString 과 equals 메서드를 오버라이딩해서 사용
        Member m = new Member();
        m.userid = "abc123";
        m.passwd = "987xyz";
        ...
        // => 클래스의 멤버변수를 출력할때는 toString 메서드 사용
        ...
        // ex) 3.1415926 에서 round 메서드를 이용해서
        // 소수점 2째 자리까지 구하려면?
