...
public class Serialization {
    public static void main(String[] args) throws IOException, ClassNotFoundException {
        ...
        // 문자:혜교 숫자:87 => 파일로 저장 => 문자:혜교 문자:87

        // numbers.txt 에 저장된 정수를 읽어 더한 후 출력
        String fpath = "/users/yjm/desktop/Java/numbers.txt";
        ...
        // 직렬화 : 데이터/객체를 바이트 형태로 저장함
        // ObjectOutputStream, ObjectInputStream 클래스 사용

        // 직렬화
        String fpath2 = "/users/yjm/desktop/Java/serialize.dat";
