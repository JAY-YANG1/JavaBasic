package jaemuk.basic.day15;

import java.io.*;

public class ByteStream {
    public static void main(String[] args) {
        // 바이트 단위 스트림 - 스트림을 바이트로 처리함
        // 파일을 바이트 단위로 입출력 하려면
        ...
        // 파일에 쓰기
        String fpath = "/users/yjm/desktop/Java/info2.txt";
        ...
        // 파일에 쓰기 2
        String fpath2 = "/users/yjm/desktop/Java/info3.txt";
        ...
        InputStreamReader isr = null;   // 한글처리
        ...
        try {
            ...
            // InputStreamReader 덕에 한글이 제대로 출력
        ...
        try {
            ...
            // readData 에 저장된 바이트를 하나씩 꺼내 문자로 변환
            System.out.println(result);
            // 한글처리 기능이 없으므로 한글이 깨짐
            // 데이터가 채워지지 않은 자리에는 빈값으로 저장
