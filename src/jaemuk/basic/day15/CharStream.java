...
public class CharStream {
    public static void main(String[] args) {
        ...
        // Reader / Writer => FileReader / File Writer
        ...
        // 파일에 쓰기
        String fpath = "/users/yjm/desktop/Java/info.txt";      // 저장위치 & 파일명
        ...
        // 파일 읽기 1 : 파일로부터 문자를 하나씩 읽어 화면에 출력
        FileReader fr = null;
        try {
            ...
            // (ch = fr.read()) != -1 : ch 변수에 저장된 코드값이 -1 이 아니라면
            //                          즉, 읽어온 코드가 유효하지 않다면
            while ((ch = fr.read()) != -1) {
